...
namespace PM
{
    public partial class fm_PM_Main : FormMainBase
    {
        ...
        protected override void s_MenuFinalizeExecute()
        {
            ...
            //3. CreateTableModule      - Генерация модулей таблиц БД
            ...
            tsm = MenuItemByLabel("CreateTableModule"); // fix 16872
            if (tsm != null)
            {
                tsm.Visible = FuncDB.IsSysAdmin(s_UserEntity.Login);
            }
         ...
         */
        /// <summary>  fix 16872
        /// Генерация модулей таблиц БД (вызов из меню, метка CreateTableModule)
        /// </summary>
        /// <param name="sender"></param>
        /// <param name="parameters"></param>
